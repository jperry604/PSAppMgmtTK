...
$appVersion = "1.1.0"
$VersionFilePath = "C:\Program Files\ITS\StartMenuLayouts\Version.txt"
if( (Test-Path $Filepath -PathType Leaf) -and (Test-Path $VersionFilePath -PathType Leaf) ) {
    if( ([System.Version]::Parse((Get-Content $VersionFilePath))) -ge ([System.Version]::Parse($appVersion))){
